...
public class RedisConfig {
        ...
        @Bean
        public RedisTemplate<String, HelloMessage> redisTemplateMessage(RedisConnectionFactory connectionFactory) {
            RedisTemplate<String, HelloMessage> redisTemplateMessage = new RedisTemplate<>();
